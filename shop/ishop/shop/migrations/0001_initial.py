    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_price', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='USD', max_digits=14)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Product', 'Product'), ('Interior', 'Interior'), ('Exterior', 'Exterior'), ('GroundCoverage', 'GroundCoverage'), ('Fence', 'Fence'), ('Paint', 'Paint'), ('Light', 'Light'), ('FloorCoverage', 'FloorCoverage'), ('Plumbing', 'Plumbing'), ('Furniture', 'Furniture')], default='Product', max_length=15, verbose_name='Category')),
                ('img', models.ImageField(blank=True, upload_to='shop')),
                ...
                ('discount_price', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='USD', max_digits=14)),
                ('seller', models.ForeignKey(default='1', on_delete=django.db.models.deletion.CASCADE, to='accounts.Profile')),
            ],
        ),
        migrations.CreateModel(
            name='Exterior',
        ...
        migrations.CreateModel(
            name='Fence',
            fields=[
                ('exterior_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='shop.Exterior')),
        ...
        migrations.CreateModel(
            name='FloorCoverage',
            fields=[
                ('interior_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='shop.Interior')),
